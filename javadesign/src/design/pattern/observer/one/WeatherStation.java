package design.pattern.observer.one;

/**
 * 옵저버 패턴(java에서 제공하는 api 사용) 예제 아래 내용 참조
...
public class WeatherStation {
	...
	public static void weatherStation() { // weatherStation 초기화
		...
		currentDisplay = new CurrentConditionDisplay(weatherData); // CurrentConditionDisplay
																	// 생성
																	// (WeatherData에
																	// 옵저버 등록)
		forecastDisplay = new ForecastDisplay(weatherData); // ForecastDisplay
															// 생성 (WeatherData에
															// 옵저버 등록)
	}
