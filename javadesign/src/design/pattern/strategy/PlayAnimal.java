...
import design.pattern.strategy.animal.Animal;
import design.pattern.strategy.animal.Eagle;
import design.pattern.strategy.animal.Tiger;
import design.pattern.strategy.animal.Turtle;

/**
 * 아래 사이트에 있는 전략패턴에 대한 예제
 * 참조: http://hyeonstorage.tistory.com/146
 * 
 * @author july
 *
 */
